...
<div class="sidebar d-none d-md-block">
    <!-- ĐÃ SỬA: Logo giờ là thẻ A trỏ về index.php và dùng class brand-logo -->
...
<div class="main-content">
    ...
    <div class="row g-4 mb-5">
        ...
        <?php if(isLoggedIn()): ?>
            ...
            <div class="col-md-8">
                <!-- Liên kết Bán hàng & Thu ngân (Áp dụng cho Admin HOẶC Sales) -->
                <a href="<?php echo ($is_admin || $current_role === 'sales') ? 'admin_dashboard.php' : '#'; ?>" class="feature-card bg-sales p-4 rounded-0">
